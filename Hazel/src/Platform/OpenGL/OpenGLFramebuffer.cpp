...
namespace Hazel {
	...
	namespace Utils {
		...
		static GLenum HazelFBTextureFormatToGL(FramebufferTextureFormat format)
		{
			...
			HZ_CORE_ASSERT(false, "Error Format");
			return 0;
		}
	}

	Hazel::OpenGLFramebuffer::OpenGLFramebuffer(const FramebufferSpecification& spec)
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		{
			HZ_CORE_ASSERT(m_ColorAttachments.size() <= 4,"ColorAttachment num > 4");
		...
		HZ_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebffer is incomplete!");
