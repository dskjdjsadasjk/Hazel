...
#define PROFILE_SCOPE(name) Timer timer##__LINE__(name,[&](ProfileResult profilerResult) {m_ProfileResults.push_back(profilerResult); })
*/
Sandbox2D::Sandbox2D()
...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
	...
	Hazel::Renderer2D::BeginScene(m_CameraController.GetCamera());
	Hazel::Renderer2D::DrawQuad({ 0.0f,0.0f,0.5f }, { 1.f,1.0f }, m_TextureStairs);
	Hazel::Renderer2D::DrawQuad({ -1.0f,0.0f,0.5f }, { 1.f,2.0f }, m_TextureTree);
	Hazel::Renderer2D::EndScene();
